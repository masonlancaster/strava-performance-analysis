...
def retrieve_insights(activity_list):
    ...
    df.to_csv('strava-activities.csv')
    print('nothing')
...
def post_token():
    response = requests.post('https://www.strava.com/oauth/token?client_id=105933&client_secret=06088798f36c23bd90aa56de4077e28feff5075c&code=08c38a491d9dcd02c3dcecc3823ecf2100bc8029&grant_type=authorization_code')
    print('nothing')
